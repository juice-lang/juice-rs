...
use ariadne::Color;
use juice_core::diag::{Colored, DiagnosticKind};
use juice_macros::diagnostic;

diagnostic!(
    [error] SimpleError => "This is a simple error",
    [warning] SimpleWarning => "This is a simple warning",
    [static error] StaticError => "This is a static error",
    [static warning] StaticWarning => "This is a static warning",
    ...
    [static error] StaticErrorWithArg(number: u32) => "This is a static error with an argument: {}",
    [static warning] StaticWarningWithArg(string: &'static str) => "This is a static warning with an argument: {}",
    [error] ErrorWithManyArgs(a: u32, b: i32, c: f32, d: &'static str) =>
        "This is an error with many arguments: {}, {}, {}, {}",
    [warning] WarningWithManyArgs(a: u32, b: i32, c: f32, d: &'static str) =>
        "This is a warning with many arguments: {}, {}, {}, {}",
    [static error] StaticErrorWithManyArgs(a: u32, b: i32, c: f32, d: &'static str) =>
        "This is a static error with many arguments: {}, {}, {}, {}",
    [static warning] StaticWarningWithManyArgs(a: u32, b: i32, c: f32, d: &'static str) =>
    ...
    [static error] StaticErrorWithIntoArg(string: into String) => "This is a static error with an into argument: {}",
    [static warning] StaticWarningWithIntoArg(string: into String) =>
        "This is a static warning with an into argument: {}",
    ...
    [static error] StaticErrorWithColoredArg(colored: into Colored<u32>) =>
        "This is a static error with a colored argument: {}",
    [static warning] StaticWarningWithColoredArg(colored: into Colored<u32>) =>
...
mod tests {
    ...
    fn test_simple_warning() {
        ...
        assert_eq!(diagnostic.error_code(), 1);
    ...
    fn test_static_error() {
        ...
        assert_eq!(diagnostic.error_code(), 2);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Error);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_static_warning() {
        ...
        assert_eq!(diagnostic.error_code(), 3);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Warning);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_error_with_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 4);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Error);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_warning_with_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 5);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Warning);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_static_error_with_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 6);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Error);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_static_warning_with_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 7);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Warning);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_error_with_many_args() {
        ...
        assert_eq!(diagnostic.error_code(), 8);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Error);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_warning_with_many_args() {
        ...
        assert_eq!(diagnostic.error_code(), 9);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Warning);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_static_error_with_many_args() {
        ...
        assert_eq!(diagnostic.error_code(), 10);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Error);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_static_warning_with_many_args() {
        ...
        assert_eq!(diagnostic.error_code(), 11);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Warning);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_error_with_into_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 12);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Error);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_warning_with_into_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 13);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Warning);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_static_error_with_into_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 14);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Error);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_static_warning_with_into_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 15);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Warning);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_error_with_colored_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 16);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Error);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_warning_with_colored_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 17);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Warning);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_static_error_with_colored_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 18);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Error);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
    ...
    fn test_static_warning_with_colored_arg() {
        ...
        assert_eq!(diagnostic.error_code(), 19);
        assert_eq!(diagnostic.kind(), DiagnosticKind::Warning);
        assert_eq!(
            diagnostic.clone().into_formatted_message(None),
